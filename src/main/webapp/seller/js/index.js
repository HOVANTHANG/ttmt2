...
async function thongke() {
    var url = 'http://localhost:8080/api/statistic/seller/revenue-this-month';
    ...
    var url = 'http://localhost:8080/api/statistic/seller/number-product';
    ...
    var url = 'http://localhost:8080/api/statistic/seller/revenue-today';
    ...
    var url = 'http://localhost:8080/api/statistic/seller/number-invoice-today-finish';
