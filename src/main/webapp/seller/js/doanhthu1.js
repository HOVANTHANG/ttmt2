...
async function revenueYear(nam) {
    ...
    var url = 'http://localhost:8080/api/statistic/seller/revenue-year?year=' + nam;
...
async function loadLichSuNap() {
    ...
    var url = 'http://localhost:8080/api/seller/all-history-pay';
    if (start != "" && end != "") {
        url = 'http://localhost:8080/api/seller/all-history-pay?start=' + start + '&end=' + end;
    }
    const response = await fetch(url, {
        method: 'GET',
        headers: new Headers({
